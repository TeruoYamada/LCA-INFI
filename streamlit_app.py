...
# Apenas após definir todas as funções necessárias
...
if st.button("🎞️ Gerar Análise Completa", type="primary", use_container_width=True):
    try:
        ...
        st.write("Por favor, verifique os parâmetros e tente novamente.")# Função para extrair valores de AOD para um ponto específico
